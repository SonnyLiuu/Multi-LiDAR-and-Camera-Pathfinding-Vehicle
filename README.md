...
The target color is selected by running vision_controller.py and adjusting the HSV thresholds, as shown above, to isolate the color of the target object.
